...
define("LM_MYSQLDUMP_PATH","MySQLDump Pfad oder Befehl:<br />Für große MySQL Dumps nutze bitte den Befehl
...
define("LM_G_EXCLUDE_COMMENT","<br>Auszuschließende Ordner bitte hier angeben. 1 Ordner pro Zeile.
    <br><b>Möglicherweise willst du die das Cache Feature deaktivieren, während du ein Backup erstellst. Ansonsten kannst du auch das Cache Verzeichnis vom Backup ausschließen.</b>");
...
deinem Hoster, folgenden Befehl hinzufügen:<br />");
...
define("LM_CRON_MODE_INFO"," <br />
      <small>*: Wenn 'Lokaler Server' ausgewählt wird, dann wird der default Backup Pfad aus dem Tab 'Allgemein' genutzt, um das Backup zu speichern.</small>
      <br /><br />
      <small>**: Wenn 'Email' ausgewählt wird, dann kann nicht garantiert werden, dass das Backup korrekt zugestellt wird, wenn Provider Einschränkungen überschritten werden (Speicherplatz, etc.).</small>
     ");
...
define("LM_COL_FOLDER"    , "<b>Verzeichnisse und / oder Dateien ausschließen</b>");
...
define("LM_CONFIRM_INSTRUCTIONS"    , "<b>Bitte wähle die Verzeichnisse, die von der Backuperstellung ausgeschlossen werden sollen.</b>  <br />
...
Und folgende Arbeitsschritte sind dafür notwendig:
   ...
   <b>Schritt 2 - XCloner Wiederherstellungsskript</b>
    ...
    - Für die eigentliche Wiederherstellung des Backups hast du <b>zwei Optionen:</b>
