...
<?php if ($comments) : ?>
	...
	<?php wp_list_comments('type=comment&callback=gemerz_comment&end-callback=gemerz_end_comment&max_depth=23'); ?>
	</ol>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<div id="comment-author-info">
		...
		<p>
			...
			<label for="email">邮箱<?php if ($req) echo " *"; ?> <a id="Get_Gravatar"  title="查看如何申请一个自己的Gravatar全球通用头像" target="_blank" href="http://gemerz.com/wordpress-headimage-set.html">（教你设置自己的个性头像）</a></label><span><script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/realgravatar.js"></script></span>
		</p>
		<p>
...
google_ad_client = "ca-pub-0198791614011943";
/* ad 3 */
google_ad_slot = "5237964708";
google_ad_width = 728;
google_ad_height = 15;
//-->
</script>
