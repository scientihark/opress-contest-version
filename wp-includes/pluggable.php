...
if ( !function_exists( 'get_avatar_scientihark' ) ) :
/**
...
*/
function get_avatar_scientihark( $id_or_email, $size = '96', $default = '', $alt = false ) {
	...
	return apply_filters('get_avatar_scientihark', $avatar, $id_or_email, $size, $default, $alt);
}
endif;
