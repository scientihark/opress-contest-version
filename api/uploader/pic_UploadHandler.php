...
if (!$con)
{
	...
	$ismedia=1;
	$ispic=1;
	if($itype!="png"&&$itype!="jpg"&&$itype!="gif"&&$itype!="bmp")
	{$ispic=0;}
	if($ispic==0){exit();}
    ...
    if(move_uploaded_file($tempLoc,$target_path))
    {
		...
		$sql1 = "INSERT INTO contest_project_pics(fname,pid)VALUES('$fileName','$uid')";
		//echo $sql1;
		$result=mysql_query($sql1,$con);
		$sql1 = "SELECT id FROM contest_project_pics WHERE fname='$fileName' and pid='$uid'";
		$result=mysql_query($sql1,$con);
